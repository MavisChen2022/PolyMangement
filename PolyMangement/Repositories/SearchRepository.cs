...
namespace PolyMangement.Repositories
{
    public class SearchRepository : BaseRepository, ISearchRepository
    {
        ...
        public IEnumerable<SearchModel> GetByValue(DateTime choice)
        {
            string startTime = choice.ToString("yyyy-MM-dd");
            string endTime= choice.AddDays(1).ToString("yyyy-MM-dd");
